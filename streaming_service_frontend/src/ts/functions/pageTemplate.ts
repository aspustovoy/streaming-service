export function pageTemplate(): string {
  return `<div class="modal-overlay">
    <div class="playlists-modal">
      ...
      <div class="playlists-modal__playlist_content">
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(2).jpg" alt="Плейлист #1" class="playlists-modal__playlist__image" />
          <div class="playlists-modal__playlist__title">Плейлист #1</div>
          <div class="playlists-modal__playlist__info">Нет треков</div>
        </button>
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(3).jpg" alt="Плейлист #2" class="playlists-modal__playlist__image" />
          <div class="playlists-modal__playlist__title">Плейлист #2</div>
          <div class="playlists-modal__playlist__info">Нет треков</div>
        </button>
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(4).jpg" alt="Плейлист #3" class="playlists-modal__playlist__image" />
          <div class="playlists-modal__playlist__title">Плейлист #3</div>
          <div class="playlists-modal__playlist__info">Нет треков</div>
        </button>
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(5).jpg" alt="Плейлист #4" class="playlists-modal__playlist__image" />
          <div class="playlists-modal__playlist__title">Плейлист #4</div>
          <div class="playlists-modal__playlist__info">Нет треков</div>
        </button>
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(6).jpg" alt="Плейлист #5" class="playlists-modal__playlist__image" />
          <div class="playlists-modal__playlist__title">Плейлист #5</div>
          <div class="playlists-modal__playlist__info">Нет треков</div>
        </button>
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(7).jpg" alt="Плейлист #6" class="playlists-modal__playlist__image" />
          <div class="playlists-modal__playlist__title">Плейлист #6</div>
          <div class="playlists-modal__playlist__info">Нет треков</div>
        </button>
        <button class="playlists-modal__playlist">
          <img src="img/playlists%20(8).jpg" alt="Плейлист #7" class="playlists-modal__playlist__image" />
  ...
  <div class="over-wrapper" style="position: relative; overflow: hidden; ">
    <header class="header flex">
      <a class="header__logo" href="/"><svg width="143" height="29" viewBox="0 0 143 29" fill="none"
